document.addEventListener('DOMContentLoaded', () => {
    ...
    logoImage.src = 'assets/starbucks_logo.svg'; // Path to your local logo file

    const kettleImage = new Image();
    kettleImage.src = 'assets/kettle.png'; // Path to your local kettle image

    const whiskImage = new Image();
    whiskImage.src = 'assets/whisk.png'; // Path to your local whisk image
